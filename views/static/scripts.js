function addTask() {
    ...
    newdiv.innerHTML = "<input type='text' class='txt' placeholder='Description' >" + "<img src='/images/check.png' class='checked'>" + "<input type='text' class='date' placeholder='deadline'"
...
function add_cTask() {
    let newdiv = document.createElement("div");
    newdiv.innerHTML = "<input type='text' class='checks' placeholder='Description'>" + "<img src='/images/checked.png' class='checked'>" + "<input type='text' class='date' placeholder='deadline'"
